...
public sealed class CartOrderServiceTests
{
    ...
    {
        var sut = CreateSut();
        _repoMock.Setup(r => r.SelectLicenseOptionsAsync("BAD_KEY", It.IsAny<CancellationToken>()))
    ...
    public async Task GetLicenseOptionsAsync_Found_ReturnsOk()
    {
        ...
        _repoMock.Setup(r => r.SelectLicenseOptionsAsync("KEY123", It.IsAny<CancellationToken>()))
